...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLocation("http://192.168.1.6/androidwebservice/wasteLocation.php");
    ...
    private void reportWaste() {
        ibtn_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("wasteLocation_latitude",latitude);
                intent.putExtra("wasteLocation_longtitude",longtitude);
  ...
  /*  private void sendRequestDirection() throws IOException {
        String destination = searchViewLocation.getQuery().toString();
        if(destination.isEmpty()){
            Toast.makeText(this, "Please enter destinationa address!    ", Toast.LENGTH_SHORT).show();
        }
        Geocoder geocoder = new Geocoder(MapsActivity.this);
        List<Address> addressList = geocoder.getFromLocationName(destination,1);
        Address address = addressList.get(0);
        Double lattitudeDirection = address.getLatitude();
        Double longtitudeDirection = address.getLongitude();
  ...
  private void joinDialog(){
      ...
      mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
          ...
          public boolean onMarkerClick(final Marker m) {
              ...
              bundle.putDouble("wasteLattitude",m.getPosition().latitude);
